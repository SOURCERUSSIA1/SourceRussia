...
async def help(client: Client, message: Message):
    ...
    await message.reply_sticker("https://telegra.ph/file/2d1372d13b7b8f496b0d1.jpg")
            ...
            [
                [
                    InlineKeyboardButton(
                        "🐰 ¦ جـروب الدعم ", url=f"https://t.me/RUSSIA_TEST"
                    ),
                    InlineKeyboardButton(
                        " 🦦 ¦ قنــاة البـوت ", url="https://t.me/X_x_RUSSIA_x_X"
                    )
                ]
            ]
        ),
