...
@Client.on_message(
    command(["تشغيل", "/play", "روسيا" ,"جاميكا" ,"روسي"])
    & filters.group
    & ~filters.edited
    & ~filters.forwarded
    & ~filters.via_bot
...
async def play(_, message: Message):
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(" ☣️ ¦ الدعم ", url=f"https://t.me/RUSSIA_TEST}"),
                    InlineKeyboardButton(" 🧨 ¦ قناة السـورس ", url=f"https://t.me/X_x_RUSSIA_x_X")
                ],
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(" ☣️ ¦ الدعم ", url=f"https://t.me/RUSSIA_TEST"),
                    InlineKeyboardButton(" 🧨 ¦ قـناة السـورس ", url=f"https://t.me/X_x_RUSSIA_x_X")
                ],
                [InlineKeyboardButton(" ⚙️ ¦ اخفاء  ", callback_data="close_play")
                ],
            ]
