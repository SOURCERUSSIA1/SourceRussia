    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                f"ʜᴇʏ {message.from_user.mention()},\nᴛʜɪs ɪs [{bn}](t.me/{lel}) ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ ᴀᴄᴄᴏᴜɴᴛ.\n\nᴅᴏɴ'ᴛ ᴛʀʏ ᴛᴏ sᴘᴀᴍ ʜᴇʀᴇ ᴇʟsᴇ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ ꜰᴜ*ᴋᴇᴅ ʙʏ [𝑅𝐔𝑆𝑆𝐼𝐴𝑆𝑂𝐔𝑅𝐶𝐸 𖢔](https://t.me/RUSSIA_MUSIC222).\n",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " 🐥 ¦ bot russia ", url=f"https://t.me/AL_DESOUKI_bot"
                    ),
                    InlineKeyboardButton(
                        " 🦦 ¦ جـروب الدعم ", url="https://t.me/RUSSIA_TEST"
                    )
                ],[ 
                    InlineKeyboardButton(
                        " ☢️ ¦قناة البوت ", url=f"https://t.me/X_x_RUSSIA_x_X"
                    )]
            ]
        ),
